package com.snake.nethard.repository;

import com.snake.nethard.NethardApp;
import com.snake.nethard.config.Constants;
import com.snake.nethard.config.audit.AuditEventConverter;
import com.snake.nethard.domain.PersistentAuditEvent;
...
import static com.snake.nethard.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
