...
import static com.snake.nethard.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = NethardApp.class)
public class EmployeeResourceIntTest {
    ...
    private static final Long DEFAULT_YEARLY_SALARY = 1L;
    private static final Long UPDATED_YEARLY_SALARY = 2L;

    private static final Long DEFAULT_COMMISSION_PCT = 1L;
    private static final Long UPDATED_COMMISSION_PCT = 2L;

    private static final EmployeeType DEFAULT_TYPE = EmployeeType.HOURLY;
    private static final EmployeeType UPDATED_TYPE = EmployeeType.MONTHLY;
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getYearlySalary()).isEqualTo(DEFAULT_YEARLY_SALARY);
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].yearlySalary").value(hasItem(DEFAULT_YEARLY_SALARY.intValue())))
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.yearlySalary").value(DEFAULT_YEARLY_SALARY.intValue()))
    ...
    public void updateEmployee() throws Exception {
        ...
        updatedEmployee
            ...
            .yearlySalary(UPDATED_YEARLY_SALARY)
        ...
        assertThat(testEmployee.getYearlySalary()).isEqualTo(UPDATED_YEARLY_SALARY);
